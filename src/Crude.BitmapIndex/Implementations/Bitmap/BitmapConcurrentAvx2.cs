...
namespace Crude.BitmapIndex.Implementations.Bitmap
{
    internal sealed class BitmapConcurrentAvx2: IBitmap
    {
       private readonly long[] _mapArray;
        ...
        public unsafe bool Any(IBitmap other)
        {
        ...
        public unsafe bool All(IBitmap other)
        {
            var valueArray = other.AsSpan();
        ...
        public unsafe IBitmap AndNot(IBitmap other)
        {
            var valueArray = other.AsSpan();
        ...
        public unsafe IBitmap And(IBitmap other)
        {
            var valueArray = other.AsSpan();
        ...
        public unsafe IBitmap Or(IBitmap other)
        {
            var valueArray = other.AsSpan();
